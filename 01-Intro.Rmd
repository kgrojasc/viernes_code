...
Quiere analizar el comportamiento de la temperatura mensual en Barranquilla. Consigue la siguiente tabla de datos
...
1. Cree un vector para cada columna
2. Una los vectores y conviértalos en un objeto data frame
3. Genere una nueva columna donde muestre cuanto mayor es la temperatura máxima en relación a la mínima
4. Grafique esta relación para cada mes ¿Hay algún patrón?
5. Calcule la temperatura media promedio para el año completo
...
¿Qué puede decir? Escriba su interpretación de esta gráfica
